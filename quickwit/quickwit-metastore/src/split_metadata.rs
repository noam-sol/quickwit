...
pub struct SplitMetadata {
    ...
    /// If an index timestamp field is available, the min / max index timestamp in
    /// the split, expressed in seconds.
    pub index_time_range: Option<RangeInclusive<i64>>,
...
impl fmt::Debug for SplitMetadata {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        ...
        debug_struct.field("index_time_range", &self.index_time_range);
...
impl quickwit_config::TestableForRegression for SplitMetadata {
    fn sample_for_regression() -> Self {
        SplitMetadata {
            ...
            index_time_range: Some(121000..=130198),
            create_timestamp: 3,
    ...
    fn test_split_metadata_debug() {
        ...
        let expected_output =
            "SplitMetadata { split_id: \"split-1\", index_uid: IndexUid { index_id: \
             ...
             uncompressed_docs_size_in_bytes: 1024, time_range: Some(0..=100), index_time_range: \
             Some(1..=101), create_timestamp: 1629867600, maturity: Mature, tags: \"{\\\"🐱\\\", \
             \\\"😻\\\", \\\"😼\\\", \\\"😿\\\", and 1 more}\", footer_offsets: 0..1024, \
             delete_opstamp: 0, num_merge_ops: 0 }";
